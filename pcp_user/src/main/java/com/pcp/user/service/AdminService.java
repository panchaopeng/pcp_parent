package com.pcp.user.service;

import com.pcp.user.dao.AdminDao;
...
public class AdminService {
	...
	public Admin login(Admin admin) {
		...
		//先根据用户名查询对象
		Admin admin1Login = adminDao.findByLoginname(admin.getLoginname());
		//然后拿数据库中的密码和用户输入的密码匹配
		if (admin1Login != null && passwordEncoder.matches(admin.getPassword(),admin1Login.getPassword())){
			return admin1Login;
		}
		return null;
	}
